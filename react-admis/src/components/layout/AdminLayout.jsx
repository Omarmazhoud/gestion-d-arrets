      ...
      <aside style={sidebarStyle}>
        <div style={{ display: "flex", flexDirection: "column", flex: 1, minHeight: 0 }}>
          ...
          <nav style={{ ...navContainer, flex: 1, overflowY: "auto", paddingRight: "8px" }}>
            <div style={menuGroupLabel}>MONITORING</div>
            ...
            <NavLink to="/admin/creer-ticket" style={navLinkStyle}>
              <HiPlusCircle size={20} /> Nouveau Ticket
            </NavLink>
            <NavLink to="/admin/users" style={navLinkStyle}>
              <HiUsers size={20} /> Utilisateurs
            </NavLink>
            <NavLink to="/admin/messagerie" style={navLinkStyle}>
              <HiChat size={20} /> Messagerie
            </NavLink>
            <NavLink to="/admin/machines" style={navLinkStyle}>
            ...
            <NavLink to="/admin/fournisseurs" style={navLinkStyle}>
              <HiTruck size={20} /> Fournisseurs
            </NavLink>
            <NavLink to="/admin/pieces-rechange" style={navLinkStyle}>
              <HiCollection size={20} /> Pièces Rechange
            </NavLink>

            <div style={menuGroupLabel}>ANALYSES</div>
          ...
          {user && (
            <div style={userCard}>
              ...
              <div style={userDetails}>
                ...
                <div style={userBadge}>ADMINISTRATEUR</div>
              </div>
            </div>
          )}
